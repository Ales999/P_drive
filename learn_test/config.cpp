...
class CfgVehicles
{
	...
	class bia_test_helicopter: Helicopter_Base_H
	{
		...
		displayName = "Test Heli"; 								/// how is the heli displayed in editor
		model = "\learn_test\bia_test_helicopter.p3d"; 	/// path to model of the heli
	...
	class C_Test_Heli_01_F: bia_test_helicopter
	{
		...
		faction	= "OPF_F";			/// defines the faction inside of the side
		crew = "O_Pilot_F";	/// lets use the sample soldier we have as default captain of the boat
